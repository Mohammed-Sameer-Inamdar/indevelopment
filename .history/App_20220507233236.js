...
const App = () => {
  ...
  return (
    <SafeAreaView >
      ...
      <View>
        {imageGaller.hasMore && <TouchableOpacity onPress={() => loadPhotos()}>
          <Text> Load more</Text>
        </TouchableOpacity>}
        ...
        <FlatList
          ...
          renderItem={({ item }) =>
            <TouchableOpacity style={{ width: '100%', backgroundColor: 'red', alignItems: 'center', justifyContent: 'center' }} onPress={() => imageSelected(item.node.image)}>
              <FastImage
                style={{
                  width: 140,
                  height: 200,
