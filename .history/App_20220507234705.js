    ...
    if (hasAndroidPermission()) {
      CameraRoll.getPhotos({
        ...
        .then(r => {
          ...
          let afterNum = parseFloat(imageGaller.after) + parseFloat(r.page_info.end_cursor)
          // afterNum = afterNum + r.page_info.end_cursor;
          console.log(afterNum);
          imageGaller = {
            hasMore: r.page_info.has_next_page,
            first: parseFloat(r.page_info.end_cursor),
            after: "" + (parseFloat(imageGaller.after) + r.page_info.end_cursor),
